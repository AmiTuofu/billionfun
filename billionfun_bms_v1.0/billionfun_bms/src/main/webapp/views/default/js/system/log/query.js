...
//		postData:{"name":"1212312"},
		...
		colModel:[
			...
			{name:'logName',index:'logName',width:90,search:true, editable:true},
			{name:'logIp',index:'logIp', width:50,editable: true},
			{name:'logDate',index:'logDate',width:20,search:true, editable:true},
			{name:'logLevel',index:'logLevel',width:40,search:true, editable:true},
			{name:'logClass',index:'logClass',width:20,search:true, editable:true},
			{name:'logDesc',index:'logDesc', width:70, editable: true},
			{name:'logMessage',index:'logMessage', width:150, editable: true}
		], 
		...
		},
		{
			...
			beforeShowForm : function(e) {
				...
				$("#grid-table").jqGrid('setGridParam',{ 
					editurl: ctx+"/system/log/add.json"
			    }); 
			}
		},
		{
...
//	$("#grid-table").jqGrid('filterToolbar');
	...
	function beforeDeleteCallback(e) {
		$("#grid-table").jqGrid('setGridParam',{ 
			editurl: ctx+"/system/log/delete.json"
	    }); 
		var form = $(e[0]);
	...
	function beforeEditCallback(e) {
		$("#grid-table").jqGrid('setGridParam',{ 
			editurl: ctx+"/system/log/modify.json"
	    }); 
		var form = $(e[0]);
