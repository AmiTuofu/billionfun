...
public class CodeUtil {
	public static final String SOURCES_PATH = "C:\\Users\\Administrator\\Documents\\CodeCreate\\Sources";
	public static final String TARGET_PATH = "C:\\Users\\Administrator\\Documents\\CodeCreate\\Target";
	...
	public static void main(String[] args) throws IOException{
		...
		BufferedReader module_in=new BufferedReader(new InputStreamReader(System.in));
		String module=module_in.readLine();
		System.out.println("请输入数据Model:");
		BufferedReader dataModel_in=new BufferedReader(new InputStreamReader(System.in));
		String dataModel=dataModel_in.readLine();
		System.out.println("请输入数据Model别名:");
		BufferedReader dataModelRef_in=new BufferedReader(new InputStreamReader(System.in));
		String dataModelRef=dataModelRef_in.readLine();
		System.out.println("请输入数据Model名称(中文):");
		BufferedReader dataModelName_in=new BufferedReader(new InputStreamReader(System.in));
		String dataModelName=dataModelName_in.readLine();
		System.out.println("请输入数据Model的字段:");
		BufferedReader dataModel_fields=new BufferedReader(new InputStreamReader(System.in));
		
		
		System.out.println("Create Controller...");
		File sourcesFile = new File(SOURCES_PATH+"\\Controller.java");
		File targetFile = new File(TARGET_PATH+"\\"+dataModel+"Controller.java");
		...
		System.out.println("Create "+dataModel+"Controller.java"+" Success");
		...
		targetFile = new File(TARGET_PATH+"\\"+dataModel+"ServiceImpl.java");
		FileUtils.copyFile(sourcesFile, targetFile);
		replaceByString(targetFile, "Template", dataModel);
		replaceByString(targetFile, "template", dataModelRef);
		replaceByString(targetFile, "module", module);
		System.out.println("Create "+dataModel+"ServiceImpl.java"+" Success");
	...
	public static String getMod(String module){
		return module.substring(0,1).toUpperCase()+module.substring(1,3).toLowerCase();
	}
}
